...
<?php
$subcategory = array_map(function ($products) {
  return $products['product_subcategory'];
}, $product_men);
  ...
  <div class="container py-4">
    <div class="row">
      ...
      <div class="grid col-md-11 order-md-1">
        ...
        ?>
          <div class="grid-item px-3 <?php echo $product['product_subcategory']; ?>">
            <div class="item py-3" style="width: 300px;">
              <div class="product">
                <a href="<?php printf('%s?product_id=%s', 'product.php',  $product['product_id']); ?>"><img src="<?php echo $product['product_image']; ?>" alt="Товар" class="img-fluid rounded"></a>

                <div class="text-center">
                  <h5 class="py-2 h5-font"><?php echo $product['product_name']; ?></h5>
                  ...
                  <div class="price py-2">
                    <span class="font">₽ <?php echo $product['product_price'] ?></span>
                  </div>
                  <form method="POST">
